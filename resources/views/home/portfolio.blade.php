...
@section('content')
    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                ...
                <h1 class="text-light"><a href="index.html">Pasindu Priyashan</a></h1>
    ...
    <section id="hero" bg-attr="{{ asset('uploads/images/bg.jpg') }}" class="d-flex flex-column justify-content-center align-items-center">
        <div class="hero-container" data-aos="fade-in">
            <h1>Pasindu Priyashan</h1>
            <p>I'm <span class="typed" data-typed-items="Full Stack Developer, Freelancer, Traveller"></span></p>
        </div>
    </section>
    ...
    <footer id="footer">
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>PORTSPACE.INFO</span></strong>
            </div>
            <div class="credits">Designed by <a href="https://aries.lk/">ARIES</a>
            </div>
        </div>
    </footer>
@endsection
